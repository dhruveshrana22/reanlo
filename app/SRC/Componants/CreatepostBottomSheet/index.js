...
const LogOutBootmSheet = ({ contentText, onClose, title }) => {
    ...
    const handleLogout = () => {
        ...
        dispatch(logoutUser());
        // Close the bottom sheet after logging out
        onClose();
        // Navigate to "Introduction" screen after logout
    ...
    return (
        <View style={styles.bgctr}>
            ...
            <View style={{ width: '100%', paddingHorizontal: 13, paddingVertical: 20 }}>
                <Text style={{ color: '#424242', fontSize: 22, textAlign: 'center' }}>
                    Are you sure you want to logout?
                </Text>
            </View>

            <View style={{ width: '100%', paddingHorizontal: 13, alignItems: 'center', paddingVertical: 20 }}>
                <TouchableOpacity onPress={handleLogout} style={{ backgroundColor: '#F8BB25', width: '100%', height: 50, alignItems: 'center', justifyContent: 'center', borderRadius: 50 }}>
                    <Text style={{ fontSize: 18, fontWeight: '800', color: '#424242' }}>
                        Confirm
                    </Text>
                </TouchableOpacity>
            </View>
...
const DeleteAccountBottomsheet = ({ contentText, onClose, title }) => {
...
export { BottomSheetContent, UpdateProgressBootomsheet, LogOutBootmSheet, DeleteAccountBottomsheet };
